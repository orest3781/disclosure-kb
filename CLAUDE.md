...
- `sources.json` is the only file to edit for the catalog. Run `node scripts/build-index.mjs` and `node scripts/build-review.mjs` afterwards and commit the regenerated `INDEX.md`, `catalog/` and `REVIEW.md` with it.
