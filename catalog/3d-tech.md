...
| [madjin/awesome-cc0](https://github.com/madjin/awesome-cc0) | 509 | CC0-1.0 | Awesome list of CC0 assets across the web | Find CC0 models, textures and audio — _List only_ | docs |
| [KenneyNL/Starter-Kit-Basic-Scene](https://github.com/KenneyNL/Starter-Kit-Basic-Scene) | 443 | MIT | Kenney Godot starter scene with bundled Kenney models | Source of Kenney models and a reference scene layout — _Code MIT; Kenney assets are CC0; Godot_ | docs |
...
| [ToxSam/open-source-3D-assets](https://github.com/ToxSam/open-source-3D-assets) | 160 | ⚠️ custom — read it | JSON registry of 991+ CC0 GLB models | Browse and fetch CC0 props and environments by metadata — _Repo states CC0 content, GitHub does not detect it; check each asset_ | docs |
...
| [yuyou-dev/OpenHome3D](https://github.com/yuyou-dev/OpenHome3D) | 149 | MIT | Browser home designer shipping 337 CC0 furniture models | Source of CC0 furniture GLBs and toon-shading reference — _Check per-model attribution list_ | docs |
...
| [KayKit-Game-Assets/KayKit-Character-Pack-Adventures-1.0](https://github.com/KayKit-Game-Assets/KayKit-Character-Pack-Adventures-1.0) | 58 | ⚠️ custom — read it | KayKit rigged, animated low-poly characters | Placeholder witnesses and NPCs with animations — _KayKit packs are published as CC0; confirm LICENSE_ | docs |
...
| [KayKit-Game-Assets/KayKit-City-Builder-Bits-1.0](https://github.com/KayKit-Game-Assets/KayKit-City-Builder-Bits-1.0) | 39 | ⚠️ custom — read it | KayKit low-poly city and road pieces | Small-town streets and buildings — _KayKit packs are published as CC0; confirm LICENSE_ | docs |
| [KayKit-Game-Assets/KayKit-Prototype-Bits-1.0](https://github.com/KayKit-Game-Assets/KayKit-Prototype-Bits-1.0) | 29 | ⚠️ custom — read it | KayKit prototyping blocks and props | Greybox levels quickly — _KayKit packs are published as CC0; confirm LICENSE_ | docs |
| [alvarognnzz/ambientcg-downloader](https://github.com/alvarognnzz/ambientcg-downloader) | 20 | ⚠️ none (all rights reserved — reference only) | Script to download all CC0 textures from ambientCG | Bulk fetch CC0 PBR materials for terrain, metal and concrete — _Script has no licence; textures are CC0_ | docs |
| [KayKit-Game-Assets/KayKit-Furniture-Bits-1.0](https://github.com/KayKit-Game-Assets/KayKit-Furniture-Bits-1.0) | 10 | ⚠️ custom — read it | KayKit furniture pack | Interior dressing for offices and homes — _KayKit packs are published as CC0; confirm LICENSE_ | docs |
| [KayKit-Game-Assets/KayKit-Space-Base-Bits-1.0](https://github.com/KayKit-Game-Assets/KayKit-Space-Base-Bits-1.0) | 9 | ⚠️ custom — read it | KayKit modular low-poly space base pack | Hangar, lab and secret-base props — _KayKit packs are published as CC0, GitHub does not detect the licence file; confirm LICENSE_ | docs |
| [Malcolmnixon/Quaternius-Modular-Scifi-Pack](https://github.com/Malcolmnixon/Quaternius-Modular-Scifi-Pack) | 8 | CC0-1.0 | Quaternius Modular Sci-Fi pack mirrored for Godot | Modular sci-fi interiors for a craft or facility — _Tiny mirror_ | docs |
| [Malcolmnixon/Quaternius-Ultimate-Spaceships-Pack](https://github.com/Malcolmnixon/Quaternius-Ultimate-Spaceships-Pack) | 3 | CC0-1.0 | Quaternius Ultimate Spaceships pack mirrored for Godot | CC0 spacecraft meshes as craft placeholders — _Tiny mirror; download originals from quaternius.com if possible_ | docs |
...
| Repo | ★ | License | What it is | What we take from it | Sync |
|---|---:|---|---|---|---|
| [keijiro/KinoGlitch](https://github.com/keijiro/KinoGlitch) | 2.8k | ⚠️ none (all rights reserved — reference only) | Unity analog/digital video glitch effects | Port the analog glitch (scan jitter, colour drift) math to a GLSL effect for corrupted footage — _Unity/HLSL; GitHub detects no licence, reference only_ | docs |
| [libretro/glsl-shaders](https://github.com/libretro/glsl-shaders) | 1.3k | ⚠️ none (all rights reserved — reference only) | Huge hand-ported GLSL collection incl. NTSC, VHS, CRT, scanline shaders | Mine individual NTSC/VHS/CRT passes for tape and monitor looks — _No repo-wide licence; shaders carry mixed per-file licences (many GPL), check each file before porting_ | none |
| [MirzaBeig/Post-Processing-Scan](https://github.com/MirzaBeig/Post-Processing-Scan) | 933 | Unlicense | Unity 3D scan/sonar pulse post effect (spherical SDF from depth) | Port as depth-based sonar/scanner pulse for sensor-sweep evidence scenes — _Unity/HLSL but public domain_ | docs |
| [felixturner/bad-tv-shader](https://github.com/felixturner/bad-tv-shader) | 525 | MIT | BadTV distortion/roll/static shader pass for three.js | Base for VHS/camcorder found-footage pass: vertical roll, noise, RGB shift over recovered clips — _Stale since 2019; uses old EffectComposer ShaderPass, port to pmndrs Effect_ | full |
| [staffantan/unity-vhsglitch](https://github.com/staffantan/unity-vhsglitch) | 304 | ⚠️ none (all rights reserved — reference only) | Unity VHS post-processing shader | Reference for tape-noise band and colour bleed technique — _Unity; no licence, read only_ | docs |
| [Cyanilux/URP_RetroCRTShader](https://github.com/Cyanilux/URP_RetroCRTShader) | 260 | MIT | Shader Graph CRT/VHS: warping, scanlines, static, distortion | Port node logic to a CRT monitor effect for security-cam and archive viewers — _Unity Shader Graph; port by hand_ | docs |
| [kevtoe/worldview](https://github.com/kevtoe/worldview) | 238 | MIT | CesiumJS tactical dashboard with CRT, NVG and FLIR thermal GLSL post-process modes | Readable MIT GLSL for NVG green phosphor and FLIR palettes, adaptable to postprocessing Effects — _Cesium PostProcessStage code; one of many worldview clones_ | docs |
| [NullTale/VhsFx](https://github.com/NullTale/VhsFx) | 88 | ⚠️ custom — read it | VHS post effect for Unity URP | Reference for tape look parameters (tracking, noise, bleed) — _Licence unclear, reference only_ | docs |
| [mert-dev-acc/ThermalVisionPostProcessingShader](https://github.com/mert-dev-acc/ThermalVisionPostProcessingShader) | 46 | ⚠️ none (all rights reserved — reference only) | Unity thermal goggles post effect with replacement shaders | Only dedicated thermal/FLIR repo found: technique of per-object heat values plus palette ramp ports to a three.js override material — _Unity; no licence, read only; fills FLIR gap on technique only_ | docs |
| [ntsc-rs/ntsc-rs-web](https://github.com/ntsc-rs/ntsc-rs-web) | 33 | ⚠️ none (all rights reserved — reference only) | Experimental browser (WebGPU/WASM) version of the ntsc-rs VHS emulator | Reference for accurate analog-tape artefacts, or offline processing of evidence video — _No licence detected; parent ntsc-rs is catalogued, check its licence before reuse_ | docs |
| [unframework/threejs-crt-shader](https://github.com/unframework/threejs-crt-shader) | 26 | ⚠️ none (all rights reserved — reference only) | R3F experiment rendering canvas content on a simulated 3D CRT | Pattern for in-world CRT monitors showing evidence footage — _Small; no licence, read only_ | docs |
| [mert-dev-acc/RadarShader](https://github.com/mert-dev-acc/RadarShader) | 21 | ⚠️ none (all rights reserved — reference only) | Unity radar sweep shader with object blips | Reference for radar-scope sweep and fading blips on a radar-contact evidence screen — _Unity; no licence; small_ | docs |
| [cyanideoneup/Godot-Hi-8-Demo](https://github.com/cyanideoneup/Godot-Hi-8-Demo) | 19 | MIT | Hi8/8mm camcorder emulation shader for Godot | Closest match to a 90s camcorder found-footage look; GLSL-like Godot shader ports easily — _Small repo_ | full |
| [Starlord-84/FieldStation42-VHS-MPV-Shaders](https://github.com/Starlord-84/FieldStation42-VHS-MPV-Shaders) | 15 | ⚠️ none (all rights reserved — reference only) | MPV GLSL shaders recreating 80s CRT/VHS/broadcast video | Realistic, restrained VHS reference for archive tapes — _Small; no licence, read only_ | docs |
| [SamsungInternet/three-effects](https://github.com/SamsungInternet/three-effects) | 11 | MIT | Post-processing library for three.js with attachEffects helper | Alternative effect-composition pattern for combined FLIR/NVG passes — _Small and stale since 2022_ | docs |
| [robertcorponoi/godot-night-vision-screen-shaders](https://github.com/robertcorponoi/godot-night-vision-screen-shaders) | 10 | ⚠️ custom — read it | Night-vision screen shaders ported from Shadertoy for Godot | Small readable NVG shader (grain, vignette, green tint) to port — _Tiny; licence unclear; only NVG-specific repo found_ | full |
| [KingToot14/radar_shader](https://github.com/KingToot14/radar_shader) | 7 | MIT | Godot radar/minimap sweep shader test scene | Small MIT radar sweep shader to port to GLSL — _Tiny; only permissive radar-scope code found_ | full |

### Animation & crowds

| Repo | ★ | License | What it is | What we take from it | Sync |
|---|---:|---|---|---|---|
| [zadvorsky/three.bas](https://github.com/zadvorsky/three.bas) | 1.1k | MIT | three.js Buffer Animation System: GPU animation via buffer attributes | GPU-driven animation of many objects (debris, particles, swarms) — _Stale since 2023_ | docs |
| [keijiro/HdrpVatExample](https://github.com/keijiro/HdrpVatExample) | 952 | Unlicense | Unity VAT examples with Shader Graph and VFX Graph | Canonical VAT technique reference — _Unity_ | docs |
| [wojtekpil/Godot-Octahedral-Impostors](https://github.com/wojtekpil/Godot-Octahedral-Impostors) | 311 | MIT | Octahedral impostor baker and shader for Godot | Reference for baking atlas and frame blending — _Godot; stale since 2021_ | docs |
| [sharpen3d/openvat](https://github.com/sharpen3d/openvat) | 285 | GPL-3.0 | Blender-native vertex animation texture encoder with decoders for engines | Bake crowd/creature animations to VAT textures in Blender — _GPL-3.0: tool only, run it but do not bundle its code_ | docs |
| [antzGames/OpenVAT-for-Godot](https://github.com/antzGames/OpenVAT-for-Godot) | 121 | MIT | OpenVAT decoding plus animated MultiMesh instancing for Godot | Reference for instanced VAT with per-instance animation offsets — _Godot_ | docs |
| [sweriko/Horde](https://github.com/sweriko/Horde) | 110 | MIT | Large-scale crowd simulation in three.js | Crowd rendering and steering for gatherings, base visits and military cordons | full |
| [sneha-belkhale/vertex-texture-cache](https://github.com/sneha-belkhale/vertex-texture-cache) | 29 | ⚠️ none (all rights reserved — reference only) | three.js loader for Houdini vertex animation textures | Reference VAT decode shader for three.js — _Stale since 2019; no licence_ | docs |
| [flement/VAT-blender-addon](https://github.com/flement/VAT-blender-addon) | 21 | ⚠️ none (all rights reserved — reference only) | Blender add-on generating VAT for Three.js | Three.js-oriented VAT bake path — _Small; no licence detected_ | docs |
| [Ctrlmonster/three-octahedral-impostor](https://github.com/Ctrlmonster/three-octahedral-impostor) | 16 | MIT | Octahedral impostors for three.js | Cheap distant trees, vehicles and structures around the site — _Small; agargaro/octahedral-impostor already catalogued_ | full |
| [ssethsara/react-three-npc](https://github.com/ssethsara/react-three-npc) | 13 | MIT | Yuka-based NPC control for R3F (roam, follow) | NPC witnesses and agents that patrol or follow the player — _Small; stale since 2024_ | full |
| [mikelyndon/r3f-webgl-vertex-animation-textures](https://github.com/mikelyndon/r3f-webgl-vertex-animation-textures) | 8 | ⚠️ none (all rights reserved — reference only) | R3F example playing Houdini VATs | Closest R3F-native VAT example — _Tiny; no licence, read only_ | full |
| [jango-git/animouse](https://github.com/jango-git/animouse) | 1 | MIT | Animation state machine with blend trees for three.js | Only three.js blend-tree state machine found; drive character idle/walk/inspect transitions — _Tiny, 1 star, unproven_ | full |
| [MikeFernandez-Pro/three-vat](https://github.com/MikeFernandez-Pro/three-vat) | 0 | MIT | three.js VAT library baking glTF clips at runtime for instanced crowds | Animate hundreds of instanced bystanders or witnesses in one draw call — _Brand new (Sept 2026), 0 stars, unproven; only maintained three.js VAT package found_ | full |

### Scene details

| Repo | ★ | License | What it is | What we take from it | Sync |
|---|---:|---|---|---|---|
| [a1studmuffin/SpaceshipGenerator](https://github.com/a1studmuffin/SpaceshipGenerator) | 7.8k | ⚠️ custom — read it | Blender script generating procedural 3D spaceships | Generate hull greebles and craft variants, export to glTF — _Licence file not recognised by GitHub; check before relying on it_ | docs |
| [spacejack/terra](https://github.com/spacejack/terra) | 524 | ⚠️ custom — read it | Large-scale grass and terrain rendering in WebGL/three.js | Base for field grass that can be flattened by a mask texture to form crop circles — _Licence unclear; stale_ | docs |
| [spite/THREE.DecalGeometry](https://github.com/spite/THREE.DecalGeometry) | 159 | ⚠️ none (all rights reserved — reference only) | Original decal splatter demo that became three.js DecalGeometry | Footprints, scorch rings and burn marks projected onto terrain and props — _Stale since 2017; use built-in DecalGeometry or drei Decal_ | docs |
| [jeromeetienne/threex.volumetricspotlight](https://github.com/jeromeetienne/threex.volumetricspotlight) | 137 | MIT | Volumetric spotlight cone shader for three.js | Flashlight and searchlight cones, or a cheap tractor-beam cone — _Stale since 2015; drei SpotLight is the modern equivalent_ | full |
| [cortiz2894/hologram-particles](https://github.com/cortiz2894/hologram-particles) | 99 | ⚠️ none (all rights reserved — reference only) | Hologram particle effect with three.js WebGPU TSL in Next.js | Reference for shimmering cloaking or hologram looks on the craft — _No licence detected: read only; WebGPU/TSL_ | docs |
| [Steve245270533/three-stylized](https://github.com/Steve245270533/three-stylized) | 63 | MIT | Stylised three.js meadow with instanced grass and wind | Instanced crop-field grass; add a flatten mask for crop circles | docs |
| [benpurdy/threejs-decals](https://github.com/benpurdy/threejs-decals) | 31 | ⚠️ none (all rights reserved — reference only) | Dynamic decals for three.js | Alternative dynamic decal approach — _Stale since 2015; no licence_ | docs |
| [matthew-kissinger/threejs-field-grass](https://github.com/matthew-kissinger/threejs-field-grass) | 4 | MIT | Interactive TSL grass with deterministic scatter and body wakes | Wake/flatten logic is closest code to a crop-circle ground mark — _Tiny; WebGPU TSL_ | full |
| [TrentSterling/threejs-volumetric-beam](https://github.com/TrentSterling/threejs-volumetric-beam) | 1 | MIT | three.js port of a Godot volumetric light-beam shader (cylindrical billboard + noise) | Tractor beam / landing-light beam from the craft — _Tiny; only beam-specific three.js code found_ | full |
